...
export default function DashboardHeader({title='guest', titleRoute, profileName, profileRoute, isActive=false}) {
          ...
          {openProfileDropDown && (
            ...
            >
              ...
              <div className="border-t flex items-center gap-2 p-4 text-gray-700">
                ...
                <span className={`px-2 py-1 text-sm font-medium rounded-full bg-green-100 ${isActive ? 'text-green-700' : 'text-red-700'}`}>
      ...
      {openLogoutPopup && (
        <div className="fixed inset-0 backdrop-blur-sm bg-black/40 flex items-center justify-center p-4 z-50">
          <div className="bg-white backdrop-blur-lg border border-white/30 rounded-2xl p-6 w-full max-w-sm shadow-lg">
            ...
            <p className="mt-2 text-gray-600">Do you really want to logout?</p>
