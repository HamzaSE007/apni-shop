...
export default function DashboardProfile({backPathRoute, profiletitle, profileName, profileSubTitle, email, phone, address, role, password}) {
        ...
        <div className="bg-white shadow rounded-2xl p-6">
          ...
          <div className="flex flex-wrap md:flex-nowrap items-center gap-5 pb-6 border-b">
            ...
            <div>
              ...
              <p className="text-gray-500 text-sm">{profileSubTitle}</p>
            </div>
